...
def build_dashboard(runs: list[dict], generated_at: str) -> str:
    ...
    lines = [
        ...
        "## Runs",
        "",
        "| Issue | State | Devin | PR | To-PR | ACU | Dispatched |",
        "|---|---|---|---|---|---|---|",
    ]
    for run in runs:
        ...
        lines.append(
            ...
            f"| {session} | {pr} | {to_pr} | {run.get('acus_consumed') or 0} "
    ...
    lines += [
        ...
        " ACU figures come from the Devin API and may lag until a session completes._",
    ]
    return "\n".join(lines)
